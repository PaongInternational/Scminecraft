#!/bin/bash
# opt_high.sh - Mengatur BDS ke optimasi tinggi (Performa > Hemat Baterai)

SERVER_PROPERTIES="./server/server.properties"
VIEW_DISTANCE="16"
SIMULATION_DISTANCE="8"

echo "Mengubah konfigurasi ke OPTIMASI TINGGI (Render: $VIEW_DISTANCE, Simulasi: $SIMULATION_DISTANCE)..."
